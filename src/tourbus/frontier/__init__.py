...
* :mod:`~tourbus.frontier.gkw` — the Gauss-Kuzmin-Wirsing constant from the
  transfer operator.
* :mod:`~tourbus.frontier.ramanujan` — the Rogers-Ramanujan q-continued
  fraction, its golden-ratio value at ``q = e^{-2 pi}``, and Ramanujan's
  nested radicals.
"""
...
__all__ = [
    ...
    "cube_root_cf", "nth_root_cf", "plastic_number_cf", "supergolden_cf",
    "partial_quotient_stats",
    ...
    "rogers_ramanujan_cf", "rogers_ramanujan_convergents", "rogers_ramanujan_value",
    "rogers_ramanujan_golden", "ramanujan_nested_radical", "RR_GOLDEN_VALUE",
]
